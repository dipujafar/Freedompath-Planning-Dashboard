...
import { useGetDownloadBooksQuery, IDownloadBook } from "@/redux/api/downloadBooksApi";
import { FileDown } from "lucide-react";

const EbookDownloadTable = () => {
    const { data, isLoading } = useGetDownloadBooksQuery();

    const downloads = data?.data?.data || [];

    const columns: TableProps<IDownloadBook>["columns"] = [
        {
            title: "SL",
            dataIndex: "serial",
            key: "serial",
